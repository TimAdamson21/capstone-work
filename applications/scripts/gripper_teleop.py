...
class PickPlaceTeleop(object):
    ...
    def _update_grippers(self):
        ...
        pregrasp_im = fetch_api.gripper_viz.gripper_interactive_marker(pregrasp_pose, 0.1)
        ...
        grasp_im = fetch_api.gripper_viz.gripper_interactive_marker(grasp_pose, 0.1)
        grasp_im.name = 'grasp'
        ...
        lift_im = fetch_api.gripper_viz.gripper_interactive_marker(lift_pose, 0.1)
        lift_im.name = 'lift'
